...
// do `node split` in the just-data-files folder to save all the data from the commands.json and events.json
// into `commands` and `events` back one folder.

// you must have a folders named `commands` and `events` along with the just-data-files folder


// Made by General Wrex. Thank you :)
